...
@Controller
public class AdminLszEventTargetController extends AdminBaseController implements BaseController<SjzEventIndex> {
    ...
    private final static String STATIC_BASE_URL = "/event/eventTarget";
     ...
     * @return
     */
    @RequestMapping(value = STATIC_BASE_URL+"/list",method = {RequestMethod.POST})
    @ResponseBody
