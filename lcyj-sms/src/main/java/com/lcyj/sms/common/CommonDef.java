...
public interface CommonDef
{
    ...
    /** 系统版本号 */
	String PLATFORM_VERSION = "v2.1.1";
	/** 平台中文名称
     *  ---待优化：网站名称需要从数据库中提取--
     * */
    String WEBSITE_NAME_CN = "历史轴";
    /** 平台中文名称
     * */
    String WEBSITE_SMSNAME_CN = "【SMS系统】";
    /** 平台网站名称 */
    String WEBSITE_NAME_EN = "lcyj-sms.com";
    String SERVICE_PHONE = "400-013-1876";


    /** 平台服务email,from_email账号 */
//    String EMAIL_SERVICE = "1097957468@qq.com";
    /** 平台服务email密码,from_email账号密码 */
//    String SMTP_PASSWORD = "kzhqjzghaqybjhdf";
    /** 邮箱服务域名 */
//    String SMTP_SERVER = "smtp.exmail.qq.com";
//    String SMTP_SERVER = "smtp.qq.com";

//    Tom邮箱
//    String EMAIL_SERVICE = "lishizhou@tom.com";
//    String SMTP_PASSWORD = "t_xunyu159";
//    String SMTP_SERVER = "smtp.tom.com";

    String EMAIL_SERVICE = "lishizhoufw@163.com";
    String SMTP_PASSWORD = "PDULRVBPNPLPQCGY";
     ...
     * 管理人员邮件: 定时发送平台运行情况邮件
     */
    String ADMIN_EMAIL = "hexf@lcyj-sms.com";


    /**
     * 财务人员邮件
     */
    String FINANCIAL_EMAIL = "caiwu@lcyj-sms.com";

    /**
     * 后台地址
     */
    String BACKSTAGE_ADDRESS="http://lcyj-sms.com/mgmt";
     ...
     * web服务器ip
     */
    String WEBSITE_IP = "127.0.0.2";
    
    /**
     * 域名
     */
    String WEBSITE_DOMAIN_NAME = "lcyj-sms.com";

    /**
     * 测试服务器IP
     */
    String TEST_SERVER_IP = "127.0.0.2";
    
    /**
     * web服务器端口
     */
    String WEBSITE_PORT = "80";
    ...
    final static String PIC_ROOT = "/usr/lcyj-sms/pic";
...
//资金记录类型今后请用com.lcyj-sms.core.consts.money.TradeType
...
//    public static final short TRADE_TYPE_OUT_BUY_CREDIT_RIGHTS = 1600;
     ...
     */
    BigDecimal CASH_BACK_LEVEL1 = new BigDecimal("30.00");
    
    BigDecimal CASH_BACK_LEVEL1_THRESHOLD = new BigDecimal("2000.00");
    
    /**
     * 第二档返现金额，单用户有效投资金额达到12000的时候，返现200块
     */
    BigDecimal CASH_BACK_LEVEL2 = new BigDecimal("200.00");
    
    BigDecimal CASH_BACK_LEVEL2_THRESHOLD = new BigDecimal("12000.00");
     ...
     * 710为已失效
     */
    int CASH_BACK_STATUS_NO_700 = 700;
    
    int CASH_BACK_STATUS_ONE_701 = 701;
    
    int CASH_BACK_STATUS_TWO_702 = 702;
    
    int CASH_BACK_STATUS_TEN_710 = 710;
    
    // 定时器每天的执行时间,暂时是每天晚上12:10分执行
    String QUZRTZ_RUNTIME="00:10";
    
    //--------------充值操作相关配置-----------------------------
    /* 易宝支付充值费用百分比 */
    BigDecimal RECHARGE_RATE= BigDecimal.valueOf(0.002);
    
    /*预留充值费用余额初始值*/
    BigDecimal RESERVE_FEE_BALANCE = new BigDecimal(1000);
    /**
     * 单笔最小充值额度
     */
    BigDecimal RECHARGE_AMOUNT_MIN = new BigDecimal(10);
    /**
     * 单笔最大充值额度
     */
    BigDecimal RECHARGE_AMOUNT_MAX = new BigDecimal(1000000);
    //--------------充值操作相关配置--------------------------------
    BigDecimal OVERDUE_FEE =  BigDecimal.valueOf(0.1);
}
