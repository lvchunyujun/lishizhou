...
import com.lcyj.sms.model.ThirdPartyTask;
...
public class Mail extends ThirdPartyTask
{
     ...
     *            邮件类型
     */
    public Mail(String to, String content, FromAddress from, String subject, EmailTypeEnum type)
    {
        super();
        this.to = to;
     ...
     * @param mailID 邮件id
     */
    public Mail(UUID mailID, String to, String content, FromAddress from, String subject, EmailTypeEnum type)
    {
        super(mailID);
        this.to = to;
        this.content = content;
    ...
    public static Mail fromJSONString(String jsonString) throws JSONException
    {
        ...
        EmailTypeEnum type = EmailTypeEnum.valueOf(jsonLine.getString(Mail.TYPE));
